  ...
  return (
    <div className="min-w-0">
      ...
      <main id="main-content">
        ...
        <section id="integrations" className="bg-slate-50 py-16" aria-labelledby="additional-features-heading">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <Card className="p-6">
                <Building2 className="h-8 w-8 text-orange-600" aria-hidden="true" />
              ...
              <Card className="p-6">
                <Users className="h-8 w-8 text-pink-600" aria-hidden="true" />
              ...
              <Card className="p-6">
                <Smartphone className="h-8 w-8 text-indigo-600" aria-hidden="true" />
              ...
              <Card className="p-6">
                <Cloud className="h-8 w-8 text-sky-600" aria-hidden="true" />
              ...
              <Card className="p-6">
                <Lock className="h-8 w-8 text-red-600" aria-hidden="true" />
        ...
        {/* CTA */}
        <section className="bg-emerald-600 py-16" aria-labelledby="features-cta-heading">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              <h2 id="features-cta-heading" className="text-3xl font-bold text-white">
