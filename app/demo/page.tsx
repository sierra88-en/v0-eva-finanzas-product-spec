              ...
              <div className="mt-8 rounded-lg bg-slate-50 p-6">
                <div className="flex items-center gap-3">
                  <div className="flex -space-x-2">
                    <div className="h-10 w-10 rounded-full bg-emerald-200 ring-2 ring-white" />
                    <div className="h-10 w-10 rounded-full bg-blue-200 ring-2 ring-white" />
                    <div className="h-10 w-10 rounded-full bg-purple-200 ring-2 ring-white" />
                  </div>
                  <div>
              ...
              {!submitted ? (
                <>
                  ...
                  <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                    ...
                    <Button type="submit" className="w-full gap-2" size="lg">
                      Comenzar Gratis Ahora <ArrowRight className="h-5 w-5" />
                    </Button>
                ...
                <div className="py-8 text-center">
                  ...
                  <Button className="mt-6" asChild>
                    <a href="mailto:support@evafinanzas.com">
                      Contactar Soporte
                    </a>
                  </Button>
                </div>
