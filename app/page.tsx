  ...
  return (
    <div className="min-w-0">
      ...
      <main id="main-content">
        ...
        {/* Problem Section */}
        <section className="bg-slate-900 py-16 sm:py-24" aria-labelledby="problem-heading">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
        ...
        {/* CTA Final */}
        <section className="bg-emerald-600 py-16 sm:py-24" aria-labelledby="cta-heading">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
